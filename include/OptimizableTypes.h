...
#ifndef MAM3SLAM_OPTIMIZABLETYPES_H
#define MAM3SLAM_OPTIMIZABLETYPES_H
...
class EdgeSim3ProjectXYZ : public  g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, MAM3SLAM::VertexSim3Expmap>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeSim3ProjectXYZ();
    ...
    void computeError()
    {
        const MAM3SLAM::VertexSim3Expmap* v1 = static_cast<const MAM3SLAM::VertexSim3Expmap*>(_vertices[1]);
        const g2o::VertexSBAPointXYZ* v2 = static_cast<const g2o::VertexSBAPointXYZ*>(_vertices[0]);
...
#endif //MAM3SLAM_OPTIMIZABLETYPES_H
