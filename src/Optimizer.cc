                                 ...
                                 int nIterations, bool* pbStopFlag, const unsigned long nLoopKF, const bool bRobust)
{
    ...
    vector<MAM3SLAM::EdgeSE3ProjectXYZ*> vpEdgesMono;
    vpEdgesMono.reserve(nExpectedSize);

    vector<MAM3SLAM::EdgeSE3ProjectXYZToBody*> vpEdgesBody;
       ...
       const map<KeyFrame*,tuple<int,int>> observations = pMP->GetObservations();
        ...
        for(map<KeyFrame*,tuple<int,int>>::const_iterator mit=observations.begin(); mit!=observations.end(); mit++)
        {
            ...
            if(leftIndex != -1 && pKF->mvuRight[get<0>(mit->second)]<0)
            {
                ...
                MAM3SLAM::EdgeSE3ProjectXYZ* e = new MAM3SLAM::EdgeSE3ProjectXYZ();
            ...
            if(pKF->mpCamera2){
                ...
                if(rightIndex != -1 && rightIndex < pKF->mvKeysRight.size()){
                    ...
                    MAM3SLAM::EdgeSE3ProjectXYZToBody *e = new MAM3SLAM::EdgeSE3ProjectXYZToBody();
    ...
    for(size_t i=0; i<vpKFs.size(); i++)
    {
        ...
        else
        {
            ...
            if(dist > 1)
            {
                ...
                {
                    MAM3SLAM::EdgeSE3ProjectXYZ* e = vpEdgesMono[i2];
...
void Optimizer::FullInertialBA(Map *pMap, int its, const bool bFixLocal, const long unsigned int nLoopId, bool *pbStopFlag, bool bInit, float priorG, float priorA, Eigen::VectorXd *vSingVal, bool *bHess) // FIXME remove use of first and last map KF IDs (OR DELETE FCT)
{
...
int Optimizer::PoseOptimization(Frame *pFrame)
{
    ...
    vector<MAM3SLAM::EdgeSE3ProjectXYZOnlyPose*> vpEdgesMono;
    vector<MAM3SLAM::EdgeSE3ProjectXYZOnlyPoseToBody *> vpEdgesMono_FHR;
        ...
        if(pMP)
        {
            ...
            if(!pFrame->mpCamera2){
                ...
                if(pFrame->mvuRight[i]<0)
                {
                    ...
                    MAM3SLAM::EdgeSE3ProjectXYZOnlyPose* e = new MAM3SLAM::EdgeSE3ProjectXYZOnlyPose();
            ...
            //SLAM with respect a rigid body
                ...
                if (i < pFrame->Nleft) {    //Left camera observation
                    ...
                    MAM3SLAM::EdgeSE3ProjectXYZOnlyPoseToBody *e = new MAM3SLAM::EdgeSE3ProjectXYZOnlyPoseToBody();
    ...
    for(size_t it=0; it<4; it++)
    {
        ...
        {
            MAM3SLAM::EdgeSE3ProjectXYZOnlyPose* e = vpEdgesMono[i];
        ...
        {
            MAM3SLAM::EdgeSE3ProjectXYZOnlyPoseToBody* e = vpEdgesMono_FHR[i];
...
void Optimizer::LocalBundleAdjustment(KeyFrame *pKF, bool* pbStopFlag, Map* pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges)
{
    ...
    for(size_t i=0, iend=vpEdgesMono.size(); i<iend;i++)
    {
        MAM3SLAM::EdgeSE3ProjectXYZ* e = vpEdgesMono[i];
    ...
    {
        MAM3SLAM::EdgeSE3ProjectXYZToBody* e = vpEdgesBody[i];
...
void Optimizer::OptimizeEssentialGraph(Map* pMap, KeyFrame* pLoopKF, KeyFrame* pCurKF,
                                       ...
                                       const map<KeyFrame *, set<KeyFrame *> > &LoopConnections, const bool &bFixScale) // FIXME remove use of first and last map KF IDs
{   
    // Setup optimizer
    g2o::SparseOptimizer optimizer;
    optimizer.setVerbose(false);
...
void Optimizer::OptimizeEssentialGraph(KeyFrame* pCurKF, vector<KeyFrame*> &vpFixedKFs, vector<KeyFrame*> &vpFixedCorrectedKFs,
                                       vector<KeyFrame*> &vpNonFixedKFs, vector<MapPoint*> &vpNonCorrectedMPs) // FIXME remove use of first and last map KF IDs
{
                            ...
                            const bool bFixScale, Eigen::Matrix<double,7,7> &mAcumHessian, const bool bAllPoints)
{
    ...
    // Set Sim3 vertex
    MAM3SLAM::VertexSim3Expmap * vSim3 = new MAM3SLAM::VertexSim3Expmap();
    vSim3->_fix_scale=bFixScale;
    ...
    vector<MAM3SLAM::EdgeSim3ProjectXYZ*> vpEdges12;
    vector<MAM3SLAM::EdgeInverseSim3ProjectXYZ*> vpEdges21;
    ...
    for(int i=0; i<N; i++)
    {
        ...
        MAM3SLAM::EdgeSim3ProjectXYZ* e12 = new MAM3SLAM::EdgeSim3ProjectXYZ();
        ...
        MAM3SLAM::EdgeInverseSim3ProjectXYZ* e21 = new MAM3SLAM::EdgeInverseSim3ProjectXYZ();
    ...
    if (isok) {
        ...
        {
            MAM3SLAM::EdgeSim3ProjectXYZ* e12 = vpEdges12[i];
            MAM3SLAM::EdgeInverseSim3ProjectXYZ* e21 = vpEdges21[i];
            if(!e12 || !e21)
                continue;
            ...
            if(e12->chi2()>th2 || e21->chi2()>th2)
            {
                ...
                vpEdges12[i]=static_cast<MAM3SLAM::EdgeSim3ProjectXYZ*>(NULL);
                vpEdges21[i]=static_cast<MAM3SLAM::EdgeInverseSim3ProjectXYZ*>(NULL);
                nBad++;
...
void Optimizer::InertialOptimization(Map *pMap, Eigen::Matrix3d &Rwg, double &scale, Eigen::Vector3d &bg, Eigen::Vector3d &ba, bool bMono, Eigen::MatrixXd  &covInertial, bool bFixedVel, bool bGauss, float priorG, float priorA) // FIXME remove use of first and last map KF IDs (OR DELETE FCT)
{
...
void Optimizer::InertialOptimization(Map *pMap, Eigen::Vector3d &bg, Eigen::Vector3d &ba, float priorG, float priorA) // FIXME remove use of first and last map KF IDs (OR DELETE FCT)
{
...
void Optimizer::InertialOptimization(Map *pMap, Eigen::Matrix3d &Rwg, double &scale) // FIXME remove use of first and last map KF IDs (OR DELET FCT)
{
    int its = 10;
    long unsigned int maxKFid = pMap->GetMaxKFid();
    const vector<KeyFrame*> vpKFs = pMap->GetAllKeyFrames();
...
void Optimizer::OptimizeEssentialGraph4DoF(Map* pMap, KeyFrame* pLoopKF, KeyFrame* pCurKF,
                                       const LoopClosing::KeyFrameAndPose &NonCorrectedSim3,
                                       const LoopClosing::KeyFrameAndPose &CorrectedSim3,
                                       const map<KeyFrame *, set<KeyFrame *> > &LoopConnections) // FIXME remove use of first and last map KF IDs (OR DELETE FCT)
{
